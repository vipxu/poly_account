<template>
  <el-table :data="data" border style="width: 100%" :row-style="showTr" stripe>
    <el-table-column :label="columns[0].text" header-align="center">
    ...
    <el-table-column label="期末余额" header-align="center">
      <el-table-column :label="columns[8].text" header-align="center" align="right">
        <template scope="scope">
          <p v-text="scope.row[columns[8].dataIndex]=='0'?'':moneyChange.outputmoney(scope.row[columns[8].dataIndex])"></p>
        </template>
      </el-table-column>
      <el-table-column :label="columns[9].text" header-align="center" align="right">
        <template scope="scope">
