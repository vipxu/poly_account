    ...
    <div id="page_Voucher">
        <el-row class="el-card--custom">
            <el-row>
                ...
                <div class="fr">
                    <div class="hotkeys">
                        <img src="../assets/img/vchKeyBoard.png" height="368" width="394">
                    </div>
        ...
        <el-dialog title="凭证摘要库" :visible.sync="dialogAbsVisible" :close-on-click-modal="false" size="tiny">
            <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" placeholder="请输入摘要内容" v-model="dialogAbsData.textarea">
            </el-input>
            ...
            <template>
                <el-table :data="dialogAbsData.tableData" show-overflow-tooltip border height="320">
                    ...
                    <el-table-column prop="date" label="摘要内容">
                    </el-table-column>
                </el-table>
            </template>
        </el-dialog>
...
<script>
import Voucher_table from '@/components/page_Voucher_table'
...
export default {
    ...
    methods: {
        ...
        //     $.ajax({
        //         type: "post",
        //         url: 'http://39.108.57.46/juzhang/acctTitCjx/queryAcctTitList',
        //         async: true,
        //         datetype: "json",
        //         data: {
        ...
        //                 treeData[i] = count(e.data.acctTits[i].subList);
        //             }
...
#page_Voucher .el-row .hotkeys {
    ...
    height: 30px;
    margin-right: 15px;
    background: url(../assets/img/ico-shortcut-key.gif) center no-repeat;
}
