            ...
            <table class="profit-table" cellpadding="0" cellspacing="0">
                <thead >
                    <tr>
                        ...
                        <td style="width:15%">行次</td>
                        <td style="width:25%">本期金额</td>
                        <td style="width:25%">上期金额</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <el-button type="text" @click="dialogTableVisible = true">货币资金</el-button>
...
.profit-table td button span {
    color: #555;
    cursor: pointer;
    outline: none;
}

.profit-table td button span:hover {
    color: rgb(0, 135, 190);
